...
fn main() -> Result<()> {
    ...
    // Ramp of characters from dark to light... Choose different set for different effects
    ...
    loop {
        ...
        //  Change target width for different sized output
...
fn convert_image_to_ascii(
    ...
    // Adjust for how your terminal font apect ratio
    const CHAR_ASPECT: f32 = 0.4;
